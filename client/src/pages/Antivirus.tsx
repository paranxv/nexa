    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                // Filter out Plans and Addons (Brand: Nexatechsol) and Laptops (e.g. Apple, Dell, etc if they were mixed, but we want ONLY brands that are NOT Nexatechsol and are likely Antivirus)
                // Actually Laptops are also NOT Nexatechsol. We need to distinguish Laptops from Antivirus.
                // Our seed data for Laptops has brands: Apple, Dell, HP, Lenovo, ASUS, Razer, Microsoft, Samsung, LG.
                // Antivirus have brands: Kaspersky, ESET, Watchdog, Webroot, Bitdefender, AVG.
                // We don't have a category field.
                // I'll filter by exclusion of known Laptop brands + Nexatechsol, OR inclusion of known Antivirus brands.
                // Since user might add more brands, inclusion list is safer if known, exclusion if unknown.
                // The prompt image showed Antivirus software.
                // Known AV brands: Kaspersky, ESET, Watchdog, Webroot, Bitdefender, AVG.

                const avBrands = ['Kaspersky', 'ESET', 'Watchdog', 'Webroot', 'Bitdefender', 'AVG']

                const products = response.data.filter((p: any) => avBrands.includes(p.brand))
            ...
            <main className="flex-1 container py-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1">
                        <div className="mb-6">
                            <h1 className="text-3xl font-bold text-dark-gray">Antivirus Software</h1>
